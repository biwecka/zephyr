...
cp zephyr.hex ../../../../../../zephyr/samples/app/sample_shell_bootloader_dfu/build/zephyr/bootloader.hex
cd ../../../../
...
mv firmware-signed.hex ../../zephyr/samples/app/sample_shell_bootloader_dfu/build/zephyr
mv update-signed.bin ../../zephyr/samples/app/sample_shell_bootloader_dfu/build/zephyr
