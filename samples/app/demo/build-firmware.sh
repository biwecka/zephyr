...
cp zephyr.hex ../../../../../../zephyr/samples/app/demo/build/zephyr/bootloader.hex
cd ../../../../
...
mv firmware-signed.hex ../../zephyr/samples/app/demo/build/zephyr
mv update-signed.bin ../../zephyr/samples/app/demo/build/zephyr
